              ...
              <div className="space-y-6 lg:sticky lg:top-8">
                ...
                <div className="rounded-xl border border-border/40 bg-card/50 p-5">
                  ...
                  <nav className="space-y-2">
                    <a href="#origin" className="block text-sm text-muted-foreground transition-colors hover:text-foreground">Why I Built This</a>
                    <a href="#product" className="block text-sm text-muted-foreground transition-colors hover:text-foreground">How It Works</a>
                    <a href="#decisions" className="block text-sm text-muted-foreground transition-colors hover:text-foreground">Every Decision Had a Reason</a>
                    <a href="#traction" className="block text-sm text-muted-foreground transition-colors hover:text-foreground">Day One and Beyond</a>
                    <a href="#screenshots" className="block text-sm text-muted-foreground transition-colors hover:text-foreground">The Product</a>
                  </nav>
                </div>
