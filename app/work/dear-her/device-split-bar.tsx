    ...
    <div>
      <div className="flex h-12 overflow-hidden rounded-lg">
        ...
        >
          ...
          <span className="text-[11px] font-semibold text-white">78% Mobile</span>
        </div>
        <div
        ...
        >
          ...
          <span className="text-[11px] font-semibold text-slate-400">22% Desktop</span>
        </div>
      </div>
      <p className="mt-2 text-[10px] text-slate-500">204 direct &middot; 26 LinkedIn &middot; 20 Instagram &middot; zero paid distribution</p>
    </div>
  );
}
